package com.huokangtou.server.util;

import com.huokangtou.server.model.StringPair;
...
public class DateUtil {
    ...
    public static void main(String... args) {
        ...
        Date githubithDate1 = DateUtil.getDate1("1988-11-15");
        System.out.println(DateUtil.millisecondToDay(DateUtil.timeDiffer(githubithDate1, new Date())));
        System.out.println(DateUtil.millisecondToYear(DateUtil.timeDiffer(githubithDate1, new Date())));
        Date githubithDate2 = DateUtil.getDate2("19881115");
        System.out.println(DateUtil.millisecondToDay(DateUtil.timeDiffer(githubithDate2, new Date())));
        System.out.println(DateUtil.millisecondToYear(DateUtil.timeDiffer(githubithDate2, new Date())));
    }
}
